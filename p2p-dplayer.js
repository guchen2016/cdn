...
function() {
    ...
    function(e, t, n) {
        ...
        console.log("\n %c DPlayer v1.25.0 b770027 %c http://dplayer.js.org \n\n", "color: #fadfa3; background: #030307; padding:5px 0;", "background: #fadfa3; padding:5px 0;"),
        t.
    default = i.
    default
    },
        ...
        q = function() {
            ...
            },
            {
                ...
                value: function(e, t) {
                    ...
                    case "hls":
                        var i = this.options.hlsjsConfig || {};
                        if (i.p2pConfig || (i.p2pConfig = {}), i.p2pConfig.tag || (i.p2pConfig.tag = "p2p-dplayer"), Hls) if (Hls.isSupported()) {
                            var a = new Hls(i);
                            a.loadSource(e.src),
                            a.attachMedia(e),
                            this.hlsjs = a,
                            this.setupP2PListeners(a)
            ...
            {
                key: "setupP2PListeners",
                value: function(e) {
                    var t = this;
                    this.p2pInfo.version = e.p2pEngine.version,
                    e.p2pEngine.on("stats",
                    function(e) {
                        t.p2pInfo.downloaded = e.totalP2PDownloaded,
                        t.p2pInfo.uploaded = e.totalP2PUploaded,
                        t.events.trigger("stats", e)
                    }).on("peerId",
                    function(e) {
                        t.p2pInfo.peerId = e,
                        t.events.trigger("peerId", e)
                    }).on("peers",
                    function(e) {
                        t.p2pInfo.peers = e.length,
                        t.events.trigger("peers", e)
                    })
                }
            }], [{
                key: "version",
        ...
        "use strict"; (function(e) {
            ...
            function c(e, t) {
                try {
                    ...
                    if (t && ("object" === (void 0 === t ? "undefined": i(t)) || "function" == typeof t)) {
                        var n = t.then;
        ...
        default,
            s.all = function(e) {
                return new s(function(t, n) {
                    ...
                    for (var s = 0; s < a.length; s++) r(s, a[s])
                })
            },
            s.resolve = function(e) {
                return e && "object" === (void 0 === e ? "undefined": i(e)) && e.constructor === s ? e: new s(function(t) {
                    t(e)
                })
            },
            s.reject = function(e) {
    ...
    function(e, t, n) {
        ...
        var i = {
            ...
            "zh-tw": {
                "CDNBye P2P Engine": "www.ikan.ooo P2P加速",
    ...
    function(e, t, n) {
        ...
        e.exports = function(e) {
            ...
            t += "\n    ",
            o.logo && (t += '\n    <div class="dplayer-logo">\n        <img src="', t += r(o.logo), t += '">\n    </div>\n    '),
            t += '\n    <div class="dplayer-danmaku"',
            o.danmaku && o.danmaku.bottm && (t += ' style="margin-bottom:', t += r(o.danmaku.bottm), t += '"'),
            t += '>\n        <div class="dplayer-danmaku-item dplayer-danmaku-item--demo"></div>\n    </div>\n    <div class="dplayer-subtitle"></div>\n    <div class="dplayer-bezel">\n        <span class="dplayer-bezel-icon"></span>\n        ',
            o.danmaku && (t += '\n        <span class="dplayer-danloading">', t += r(s("Danmaku is loading")), t += "</span>\n        "),
            ...
            o.live && (t += '\n        <span class="dplayer-live-badge"><span class="dplayer-live-dot" style="background: ', t += r(o.theme), t += ';"></span>', t += r(s("Live")), t += "</span>\n        "),
            t += '\n    </div>\n    <div class="dplayer-icons dplayer-icons-right">\n        ',
            o.video.quality && (t += '\n        <div class="dplayer-quality">\n            <button class="dplayer-icon dplayer-quality-icon">', t += r(o.video.quality[o.video.defaultQuality].name), t += '</button>\n            <div class="dplayer-quality-mask">\n                <div class="dplayer-quality-list">\n                ', u(o.video.quality,
            function(e, n) {
            ...
            t += "\n        ",
            o.screenshot && (t += '\n        <div class="dplayer-icon dplayer-camera-icon" data-balloon="', t += r(s("Screenshot")), t += '" data-balloon-pos="up">\n            <span class="dplayer-icon-content">', t += l.camera, t += "</span>\n        </div>\n        "),
            t += '\n        <div class="dplayer-comment">\n            <button class="dplayer-icon dplayer-comment-icon" data-balloon="',
            t += r(s("Send danmaku")),
            t += '" data-balloon-pos="up">\n                <span class="dplayer-icon-content">',
            t += l.comment,
            t += "</span>\n            </button>\n        </div>\n        ",
            o.subtitle && (t += '\n        <div class="dplayer-subtitle-btn">\n            <button class="dplayer-icon dplayer-subtitle-icon" data-balloon="', t += r(s("Hide subtitle")), t += '" data-balloon-pos="up">\n                <span class="dplayer-icon-content">', t += l.subtitle, t += "</span>\n            </button>\n        </div>\n        "),
            ...
            t += r(s("Unlimited danmaku")),
            t += '</span>\n                        <div class="dplayer-toggle">\n                            <input class="dplayer-danunlimit-setting-input" type="checkbox" name="dplayer-toggle-danunlimit">\n                            <label for="dplayer-toggle-danunlimit"></label>\n                        </div>\n                    </div>\n                    <div class="dplayer-setting-item dplayer-setting-danmaku">\n                        <span class="dplayer-label">',
            t += r(s("Opacity for danmaku")),
            ...
            t += '\n    <div class="dplayer-info-panel-item dplayer-info-panel-item-p2p-version">\n        <span class="dplayer-info-panel-item-title">加速器版本</span>\n        <span class="dplayer-info-panel-item-data"></span>\n    </div>\n    <div class="dplayer-info-panel-item dplayer-info-panel-item-p2p-downloaded">\n        <span class="dplayer-info-panel-item-title">P2P 下载</span>\n        <span class="dplayer-info-panel-item-data"></span>\n    </div>\n    <div class="dplayer-info-panel-item dplayer-info-panel-item-p2p-uploaded">\n        <span class="dplayer-info-panel-item-title">P2P 上传</span>\n        <span class="dplayer-info-panel-item-data"></span>\n    </div>\n    <div class="dplayer-info-panel-item dplayer-info-panel-item-peerid">\n        <span class="dplayer-info-panel-item-title">视频ID</span>\n        <span class="dplayer-info-panel-item-data"></span>\n    </div>\n    <div class="dplayer-info-panel-item dplayer-info-panel-item-peers">\n        <span class="dplayer-info-panel-item-title">对等链接数量</span>\n        <span class="dplayer-info-panel-item-data"></span>\n    </div>\n</div>\n<div class="dplayer-menu">\n    ',
            u(o.contextmenu,
            function(e, n) {
                t += '\n        <div class="dplayer-menu-item">\n            <a',
                e.link && (t += ' target="_blank"'),
                t += ' href="',
                t += r(e.link || "javascript:void(0);"),
                t += '">',
                t += r(s(e.text)),
                t += "</a>\n        </div>\n    "
            }),
            ...
            },
            {
                ...
                value: function(e) {
                    ...
                    if (this.showing) {
                        ...
                        u = function(e, n, o) {
                            for (var r = a / c(o), u = function(i) {
                                ...
                                for (var u = 0; u < o.length; u++) {
                                    var d = l(o[u]) - 10;
                                    if (d <= a - r * c(parseInt(o[u].style.width)) || d <= 0) break;
                        ...
                        for (var d = document.createDocumentFragment(), p = function(i) {
                            e[i].type = o.
                        default.number2Type(e[i].type),
                            e[i].color || (e[i].color = 16777215);
                            var r = document.createElement("div");
                            r.classList.add("dplayer-danmaku-item"),
                            r.classList.add("dplayer-danmaku-" + e[i].type),
                            e[i].border ? r.innerHTML = '<span style="border:' + e[i].border + '">' + e[i].text + "</span>": r.innerHTML = e[i].text,
                            r.style.opacity = t._opacity,
                            r.style.color = o.
                        default.number2Color(e[i].color),
                            ...
                            switch (e[i].type) {
                            case "right":
                                (l = u(r, e[i].type, s)) >= 0 && (r.style.width = s + 1 + "px", r.style.top = n * l + "px", r.style.transform = "translateX(-" + a + "px)");
                                break;
                            case "top":
                                (l = u(r, e[i].type)) >= 0 && (r.style.top = n * l + "px");
                                break;
                            case "bottom":
                                (l = u(r, e[i].type)) >= 0 && (r.style.bottom = n * l + "px");
                                break;
                            default:
                                console.error("Can't handled danmaku type: " + e[i].type)
                            }
                            l >= 0 && (r.classList.add("dplayer-danmaku-move"), d.appendChild(r))
                        },
    ...
    function(e, t, n) {
        ...
        var a = function() {
            function e() { !
                ...
                this.playerEvents = ["screenshot", "thumbnails_show", "thumbnails_hide", "danmaku_show", "danmaku_hide", "danmaku_clear", "danmaku_loaded", "danmaku_send", "danmaku_opacity", "contextmenu_show", "contextmenu_hide", "notice_show", "notice_hide", "quality_start", "quality_end", "destroy", "resize", "fullscreen", "fullscreen_cancel", "webfullscreen", "webfullscreen_cancel", "subtitle_show", "subtitle_hide", "subtitle_change", "stats", "peerId", "peers"]
            }
            return i(e, [{
                key: "on",
                value: function(e, t) {
    ...
    function(e, t, n) {
        ...
        var o = function() {
            function e(t) {
                ...
                var i = function() {
                    n.player.resize(),
                    n.isFullScreen("browser") ? n.player.events.trigger("fullscreen") : (a.
            ...
            },
            {
                ...
                value: function() {
                    ...
                    switch (n || (this.lastScrollPosition = a.
    ...
    function(e, t, n) {
        ...
        var o = function() {
            function e(t) {
                ...
                o = 0; o < this.player.template.speedItem.length; o++) i(o);
                if (this.player.danmaku) {
                    ...
                    var r = function(e) {
                        ...
                        i = ((t.clientX || t.changedTouches[0].clientX) - a.
                    ...
                    this.player.template.danmakuOpacityBarWrapWrap.addEventListener(a.
                default.nameMap.dragStart,
                    function() {
                        document.addEventListener(a.
                    default.nameMap.dragMove, r),
    ...
    function(e, t, n) {
        ...
        var a = function() {
            ...
            },
            {
                key: "update",
                value: function() {
                    this.template.infoVersion.innerHTML = "v1.25.0 b770027",
                    ...
                    this.template.infoP2pDownloaded.innerHTML = (this.player.p2pInfo.downloaded / 1e3).toFixed(2) + "MB",
                    this.template.infoP2pUploaded.innerHTML = (this.player.p2pInfo.uploaded / 1e3).toFixed(2) + "MB",
